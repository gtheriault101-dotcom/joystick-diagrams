...
save_path = output_dir.joinpath('populate_result.svg')
save_path.write_text(result, encoding='utf-8')
print('populate_result contains SimHUDVelocity?', 'SimHUDVelocity' in result)
print('Saved populate_result to', save_path)

# Now run export_device_to_templates which also saves
export_device_to_templates(export_dev, output_dir)
print('Ran export_device_to_templates')
